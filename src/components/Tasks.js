...
export default class TodoApp extends Component {
  ...
  addTask() {
    ...
    axios
      .post('https://todo-app22.herokuapp.com/tasks', newTask)
      .then(({ data }) => {
      ...
      <div className="main__contant">
        {!this.props.withoutAdd && (
          <div className="create__task__ctn">
            ...
            <button className="create__task__btn" onClick={this.addTask}>
              Добавить задачу
            </button>
          </div>
        )}
        <div className="task__list">
          ...
          <ul>
            {!this.props.withoutEmpty && !this.props.groups.tasks.length && (
